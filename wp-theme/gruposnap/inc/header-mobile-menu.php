<?php
/**
 * Menú móvil Printme — logo arriba y pie (idiomas y CTAs).
 *
 * @package Gruposnap
 */
    ...
    <div id="gruposnap-mobile-menu-template" class="gruposnap-mobile-menu__template" hidden>
        ...
        <div class="gruposnap-mobile-menu__footer">
            <div class="gruposnap-mobile-menu__actions">
                <a class="gruposnap-mobile-menu__btn gruposnap-mobile-menu__btn--whatsapp" href="<?php echo esc_url($quote_url); ?>" target="_blank" rel="noopener noreferrer">
                    <?php echo gruposnap_mobile_menu_icon_svg('whatsapp'); ?>
                    <span><?php esc_html_e('Pide tu Presupuesto', 'gruposnap'); ?></span>
                </a>
